...
##CONNECT TO DB
app.config['SQLALCHEMY_DATABASE_URI'] = os.environ.get("DATABASE_URL",  "sqlite:///blog.db")app.config['SQLALCHEMY_TRACK_MODIFICATIONS'] = False
db = SQLAlchemy(app)
...
def register():
    ...
    if form.validate_on_submit():
        ...
        user = load_user(find_id(form.email.data))
        if user:
